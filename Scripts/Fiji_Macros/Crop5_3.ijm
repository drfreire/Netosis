...
scaleBarLength = 2000; // Length in current units (pixels or micrometers)

makeRectangle(170, 800, 5392.32, 4100);
...
// Add scale bar to the entire cropped stack
    ...
    run("Scale Bar...", "width=" + scaleBarLength + " height=90 font=70 color=White background=Black location=[Lower Right] bold overlay");
